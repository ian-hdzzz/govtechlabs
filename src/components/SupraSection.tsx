...
export default function SupraSection() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-5xl font-black mb-2">
              <span className="text-[#1e3a5f]">SUPRA</span><span className="text-[#2563eb]">.</span>
            </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {features.map((feature) => (
                <div key={feature.title} className="p-4 rounded-xl bg-bg-card border border-border-default hover:border-[#2563eb]/30 transition-all">
                  <feature.icon className="text-[#2563eb] mb-2" size={24} />
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-lg bg-bg-card border border-border-default">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-[#2563eb]">$12,450.00</div>
                    </div>
                  ...
                  <div className="h-32 rounded-lg bg-bg-card border border-border-default p-4 flex items-end gap-1">
                    {[40, 65, 55, 80, 70, 90, 60, 75, 85, 95, 70, 80].map((h, i) => (
                      <div
                        key={i}
                        className="flex-1 rounded-t bg-gradient-to-t from-[#2563eb]/60 to-[#2563eb]"
                        style={{ height: `${h}%` }}
                      />
                    ))}
                  </div>
